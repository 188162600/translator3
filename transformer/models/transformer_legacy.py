...
def transformer_wmt_en_de_non_selective(args):
    ...
    args.encoder_fc1_selection_index=getattr(args, "encoder_fc1_selection_index", 1)
    args.encoder_fc2_selection_index=getattr(args, "encoder_fc2_selection_index", 2)
    ...
    args.decoder_sharing_method=getattr(args, "decoder_sharing_method", "none")
    args.decoder_enable_classifier=getattr(args, "decoder_enable_classifier", 1)
    args.decoder_fc1_selection_index=getattr(args, "decoder_fc1_selection_index", 2)
