...
@register_model("meta_transformer")
...
@register_model_architecture("meta_transformer", "meta_transformer_tiny")
...
@register_model_architecture("meta_transformer", "meta_transformer")
...
@register_model_architecture("meta_transformer", "meta_transformer_iwslt_de_en")
...
def transformer_wmt_en_de(args):
    ...
    args.encoder_total_options=getattr(args, "encoder_total_options", 4)
    ...
    args.decoder_total_options=getattr(args, "decoder_total_options", 4)
    args.decoder_sharing_method=getattr(args, "decoder_sharing_method", "none")
    
    base_architecture(args)
    
@register_model_architecture("meta_transformer", "meta_transformer_wmt_en_de_linear_selective")
def transformer_wmt_en_de_non_selective(args):
    
    args.encoder_options_each_layer=getattr(args, "encoder_options_each_layer", 4)
    args.encoder_total_options=getattr(args, "encoder_total_options", 10)
    args.encoder_sharing_method=getattr(args, "encoder_sharing_method", "all")
    
    args.encoder_fc1_selection_index=getattr(args, "encoder_fc1_selection_index", 0)
    args.encoder_fc2_selection_index=getattr(args, "encoder_fc2_selection_index", 1)
    ...
    args.decoder_sharing_method=getattr(args, "decoder_sharing_method", "all")
   
    args.decoder_fc1_selection_index=getattr(args, "decoder_fc1_selection_index", 0)
    args.decoder_fc2_selection_index=getattr(args, "decoder_fc2_selection_index", 1)
...
#     args.encoder_total_options=int(6*2*1.5)
#     args.encoder_total_options=int(6*4*1.5)
#     args.encoder_sharing_method="everywhere"
#     args.decoder_options_each_layer=4
#     args.decoder_total_options=int(6*2*1.5)
#     args.decoder_total_options=int(6*8*1.5)
...
@register_model_architecture("meta_transformer", "meta_transformer_vaswani_wmt_en_fr_big")
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, "dropout", 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture("meta_transformer", "meta_transformer_wmt_en_de_big")
...
@register_model_architecture("meta_transformer", "meta_transformer_wmt_en_de_big_t2t")
