...
from ..models.transformer_legacy import base_architecture, TransformerModel, transformer_wmt_en_de_big

@register_model("meta_transformer_align")
...
@register_model_architecture("meta_transformer_align", "meta_transformer_align")
...
@register_model_architecture("meta_transformer_align", "meta_transformer_wmt_en_de_big_align")
