...
#     # If ignore_index is specified, mask the losses for those positions
...
#     # If reduce is False, we keep the losses per batch item rather than summing them up
 
    
#     eps_i = epsilon / (lprobs.size(-1) - 1)
    
#     # Calculate final loss, keeping the batch dimension if reduce=False
#     loss = (1.0 - epsilon - eps_i) * nll_loss + eps_i * smooth_loss
    
#     return loss, nll_loss

# @register_criterion(
#     "last_loss_label_smoothed_cross_entropy2", dataclass=LabelSmoothedCrossEntropyCriterionConfig
# )
