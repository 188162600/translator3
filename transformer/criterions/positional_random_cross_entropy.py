...
import math
@dataclass
class PositionalRandomCrossEntropyCriterionConfig(FairseqDataclass):
    sentence_avg: bool = II("optimization.sentence_avg")
    size:int=II("dataset.max_tokens")
    min_loss:float=field(default=0.3, metadata={"help": "Minimum loss value for the weights"})
    max_loss:float=field(default=1, metadata={"help": "Maximum loss value for the weights"})
...
@register_criterion("positional_random_cross_entropy", dataclass=PositionalRandomCrossEntropyCriterionConfig)
